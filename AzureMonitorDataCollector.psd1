#
# Module manifest for module 'AzureMonitorDataCollector'
#
...
RootModule = "EmptyRootModule.psm1"

NestedModules = @(
    'Get-AzMonitorLogAuthorizationHeader.ps1'
    'Get-OMSAPISignature.ps1'
    'Send-OMSAPIIngestionFile.ps1'
    'Write-AzMonitorLogData.ps1'        
)
